...
class RetinaModel(object):
    ...
    def set_weights(self):
        if args.cache and os.path.exists("cache/keras_crop_model_weights_4class_reg_soft_relu.h5"):
            print("yes")
    ...
    def run(self):
        ...
        self.model.save_weights(os.path.join('cache', 'keras_crop_model_weights_4class_reg_soft_{}.h5'.format(self.activation)))
