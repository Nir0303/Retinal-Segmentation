...
class RetinaDevModel(BaseModel):
    ...
    def set_weights(self):
        if self.cache and os.path.exists("cache/keras_crop_model_weights_4class_dev_reg_relu.h5"):
            ...
            dev_model.load_weights("cache/keras_crop_model_weights_4class_dev2_reg_soft_relu.h5")
    ...
    def fit(self):
        ...
        self.model.save_weights(os.path.join('cache', 
                                             'keras_crop_model_weights_4class_dev2_reg_soft_{}.h5'.format(self.activation)))
